const IMAGES = {
  ...
  icons: {
    socialMedia: {
      github: {
        dark: new URL('./icons/dark/github.png', import.meta.url).href,
        light: new URL('./icons/light/github.png', import.meta.url).href,
      },
      gitlab: {
        dark: new URL('./icons/dark/gitlab.png', import.meta.url).href,
        light: new URL('./icons/light/gitlab.png', import.meta.url).href,
      },
      figma: {
        dark: new URL('./icons/dark/figma.png', import.meta.url).href,
        light: new URL('./icons/light/figma.png', import.meta.url).href,
      },
      linkedin: (
        <svg className="text-black dark:text-white fill-current w-8 h-8 max-lg:w-10 max-lg:h-10 hover:scale-110 hover:text-primaryLight dark:hover:text-primaryDark" xmlns="http://www.w3.org/2000/svg" viewBox="3 3 23 23">
          <path d="M24,4H6C4.895,4,4,4.895,4,6v18c0,1.105,0.895,2,2,2h18c1.105,0,2-0.895,2-2V6C26,4.895,25.105,4,24,4z M10.954,22h-2.95 v-9.492h2.95V22z M9.449,11.151c-0.951,0-1.72-0.771-1.72-1.72c0-0.949,0.77-1.719,1.72-1.719c0.948,0,1.719,0.771,1.719,1.719 C11.168,10.38,10.397,11.151,9.449,11.151z M22.004,22h-2.948v-4.616c0-1.101-0.02-2.517-1.533-2.517 c-1.535,0-1.771,1.199-1.771,2.437V22h-2.948v-9.492h2.83v1.297h0.04c0.394-0.746,1.356-1.533,2.791-1.533 c2.987,0,3.539,1.966,3.539,4.522V22z"></path>
        </svg>
      ),
      youtube: (
        <svg className="text-black  w-10 h-10 max-lg:w-12 max-lg:h-12 dark:text-white fill-current hover:scale-110 hover:text-primaryLight dark:hover:text-primaryDark" xmlns="http://www.w3.org/2000/svg" viewBox="3 3 43 43">
    ...
    dark: (
      <svg
        ...
        height='16'
        viewBox='0 0 16 16'
        className='mr-[6px] fill-current text-slate-700'
      >
        <path
          fillRule='evenodd'
          clipRule='evenodd'
    ...
    menu: (
      <svg className='text-black dark:text-white fill-current w-12 h-12 hover:scale-110' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 26">
